  ...
  "inline-flex items-center justify-center rounded-full border px-3 py-1 text-xs font-medium w-fit whitespace-nowrap shrink-0 [&>svg]:size-3 gap-1 [&>svg]:pointer-events-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive transition-[color,box-shadow] overflow-hidden",
  {
    variants: {
      variant: {
        ...
        destructive:
          "border-destructive-border bg-destructive-bg text-destructive [a&]:hover:bg-destructive-bg/80 focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40",
        outline:
          "text-foreground border-border [a&]:hover:bg-accent [a&]:hover:text-accent-foreground",
        success:
          "border-success-border bg-success-bg text-success [a&]:hover:bg-success-bg/80",
        warning:
          "border-warning-border bg-warning-bg text-warning-foreground [a&]:hover:bg-warning-bg/80",
        info:
          "border-info-border bg-info-bg text-info-foreground [a&]:hover:bg-info-bg/80",
      },
    },
    defaultVariants: {
      variant: "default",
