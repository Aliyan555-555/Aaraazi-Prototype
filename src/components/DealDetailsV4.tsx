...
export const DealDetailsV4: React.FC<DealDetailsV4Props> = ({
      ...
      <InfoPanel
        ...
        data={[
          ...
          },
          {
            ...
            value: `${formatPKR(deal.financial.commission.split.primaryAgent.amount)} (${
              deal.financial.commission.split.primaryAgent.percentage
            }%)`,
          },
        ]}
        columns={2}
  ...
  // ==================== TASKS TAB ====================
  const tasksContent = <TaskList deal={deal} currentUserId={user.id} />;
