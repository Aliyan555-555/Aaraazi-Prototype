      ...
      <DialogContent className="max-w-2xl max-h-[95vh] overflow-y-auto">
        ...
        <div className="space-y-6 py-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <Button
              ...
              className={`h-20 flex flex-col items-center justify-center gap-2 ${
                paymentType === 'receivable' ? 'bg-green-600 hover:bg-green-700' : ''
              }`}
            >
            ...
            <Button
              ...
              className={`h-20 flex flex-col items-center justify-center gap-2 ${
                paymentType === 'payable' ? 'bg-orange-600 hover:bg-orange-700' : ''
              }`}
            >
          ...
          <div className={`border rounded-lg p-4 ${
            paymentType === 'receivable' ? 'bg-green-50 border-green-200' : 'bg-orange-50 border-orange-200'
          }`}>
            <h4 className={`font-medium mb-2 ${
              paymentType === 'receivable' ? 'text-green-900' : 'text-orange-900'
            }`}>
              Accounting Impact
            </h4>
            <div className={`text-sm space-y-1 ${
              paymentType === 'receivable' ? 'text-green-800' : 'text-orange-800'
            }`}>
              {paymentType === 'receivable' ? (
                <>
