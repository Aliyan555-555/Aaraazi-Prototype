...
export const WorkspaceCard = React.memo<WorkspaceCardProps>(({
  ...
  return (
    <div
      className={cn(
        'relative group bg-white border border-gray-200 rounded-lg transition-all duration-200',
      ...
      {showSelection && onSelect && (
        ...
        >
          <input
            ...
            className="h-5 w-5 rounded border-gray-300 text-blue-600 focus:ring-blue-500 focus:ring-offset-0 cursor-pointer shadow-sm"
