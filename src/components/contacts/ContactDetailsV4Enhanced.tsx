...
export const ContactDetailsV4Enhanced: React.FC<ContactDetailsV4EnhancedProps> = ({
    ...
    <div className="p-6 space-y-6">
      ...
      {followUpStatus && (
        <Card className={`border-2 ${
          followUpStatus === 'overdue' ? 'border-red-500 bg-red-50' :
                ...
                >
                  <div className="flex items-center gap-3">
                    <div className={`w-10 h-10 rounded-full flex items-center justify-center ${
                      deal.status === 'closed' ? 'bg-green-100' : 'bg-blue-100'
                    }`}>
                      {deal.status === 'closed' ? (
              ...
              <div className="flex gap-3">
                <div className="flex-shrink-0">
                  <div className={`w-8 h-8 rounded-full flex items-center justify-center ${
                    followUpStatus === 'overdue' ? 'bg-red-100' :
        ...
        {tasks.length === 0 ? (
          <Card>
            <CardContent className="pt-6 text-center py-12">
              ...
              <Button variant="outline" onClick={() => { setEditingTask(undefined); setShowTaskForm(true); }}>
              ...
              <div>
                ...
                <div className="space-y-2">
                  {pendingTasks.map((task) => {
                    ...
                    return (
                      <Card key={task.id} className={isOverdue ? 'border-red-300' : isDueToday ? 'border-yellow-300' : ''}>
                        <CardContent className="p-4">
                          <div className="flex items-start justify-between">
                            <div className="flex-1">
                              <div className="flex items-center gap-2 mb-2">
                                ...
                                {isDueToday && <Badge variant="default" className="bg-yellow-500">Due Today</Badge>}
                              </div>
                              {task.description && (
  ...
  const tabs = [
    ...
    },
    {
      id: 'tasks',
      label: 'Tasks',
      badge: tasks.filter(t => t.status === 'pending').length > 0 ? tasks.filter(t => t.status === 'pending').length : undefined,
      content: <TasksTab />,
    },
