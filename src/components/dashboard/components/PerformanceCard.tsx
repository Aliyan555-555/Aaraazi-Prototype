    ...
    >
      ...
      <div className="flex items-start justify-between mb-3">
        ...
        <div className="flex-1">
          <h3 className="text-[#6B7280] text-sm mb-1">
            {title}
          </h3>
        </div>
      ...
      {/* Value */}
      <div className="mb-2">
        <div className={`text-[#1A1D1F] ${isLarge ? 'text-3xl' : 'text-2xl'} flex items-baseline gap-1`}>
          <span>{value}</span>
          {unit && (
      ...
      <div className="flex items-center gap-2 mb-3">
        <div className={`${trendColors.bg} px-2 py-1 rounded flex items-center gap-1`}>
          ...
          <span className={`${trendColors.text} text-xs`}>
