import { Property, Lead, User, SellCycle, PurchaseCycle, RentCycle, Contact, Document, Transaction, Commission, Expense, CRMInteraction, CRMTask, Payment, Project, LandParcel, AccountPayment, JournalEntry } from '../types';
...
const mockLeads: Lead[] = [
  {
    ...
    source: 'Website',
    notes: 'Interested in DHA Phase 5 Extension properties with easy access to main roads. Budget around 7-8 Crore PKR for corner bungalow.',
    status: 'new',
    propertyId: '1',
    agentId: '2',
  ...
  },
  {
    ...
    email: 'sadia.malik@outlook.com',
    source: 'Referral',
    notes: 'Looking for sea view apartment in Clifton Boat Basin area. Has cash payment ready and wants high floor with elevator.',
    status: 'interested',
    propertyId: '2',
    agentId: '3',
  ...
  {
    id: '3',
    name: 'Mohammad Tariq Hussain',
    phone: '+92-333-5555444',
    email: 'mtariq@business.pk',
    source: 'Cold Call',
    notes: 'Commercial investor looking for office spaces in I.I. Chundrigar Road financial district. Expanding textile export business.',
    status: 'contacted',
    propertyId: '3',
    agentId: '2',
  ...
  },
  {
    ...
    source: 'Social Media',
    notes: 'First-time buyer looking for affordable apartment in PECHS area. Bank loan pre-approved for 2 Crore PKR. Near Tariq Road preferred.',
    status: 'contacted',
    propertyId: '4',
    agentId: '3',
  ...
  },
  {
    ...
    email: 'hamza.rashid@yahoo.com',
    source: 'Walk-in',
    notes: 'Interested in budget-friendly properties in Gulshan-e-Iqbal for investment. Looking for rental income opportunities near University Road.',
    status: 'interested',
    propertyId: '5',
    agentId: '2',
  ...
  {
    id: '6',
    name: 'Farah Noor Sheikh',
    phone: '+92-321-4567890',
    email: 'farah.noor@gmail.com',
    source: 'Referral',
    notes: 'Successfully purchased a flat in PECHS last month. Very satisfied with the service and documentation support. Recommending to family.',
    status: 'converted',
    propertyId: '4',
    agentId: '3',
  ...
  },
  {
    ...
    email: 'usman@company.com.pk',
    source: 'Website',
    notes: 'Looking for family bungalow in North Nazimabad near good schools. Has two young children and needs car parking for 2 vehicles.',
    status: 'interested',
    propertyId: '6',
    agentId: '3',
  ...
  },
  {
    ...
    email: 'zara.hassan@tech.pk',
    source: 'LinkedIn',
    notes: 'IT professional relocating from Lahore to Karachi. Needs furnished rental in Bahadurabad or Clifton near airport. Budget 80-90k monthly.',
    status: 'new',
    propertyId: '7',
    agentId: '2',
    createdAt: '2024-01-25',
  ...
  },
  {
    ...
    source: 'Sign Call',
    notes: 'Saw our property board in DHA Phase 5 Extension. Wants to schedule viewing for corner bungalow this weekend.',
    status: 'contacted',
    propertyId: '1',
    agentId: '2',
    createdAt: '2024-01-24',
  ...
  },
  {
    ...
    email: 'rubina.q@email.com',
    source: 'Referral',
    notes: 'Downsizing from large bungalow in North Nazimabad. Looking for low-maintenance apartment in Clifton with sea view.',
    status: 'converted',
    propertyId: '2',
    agentId: '3',
  ...
  },
  {
    ...
    email: 'imran.malik@construction.pk',
    source: 'Cold Call',
    notes: 'Construction business owner looking for industrial plot in Korangi. Needs large space for equipment storage and workshop.',
    status: 'interested',
    propertyId: '10',
    agentId: '3',
  ...
  },
  {
    ...
    email: 'samina.khan@gmail.com',
    source: 'Website',
    notes: 'Young professional looking for brand new house in Scheme 33 near University of Karachi. First-time buyer with bank financing.',
    status: 'new',
    propertyId: '9',
    agentId: '2',
...
const migrateLeadsToContacts = (): Contact[] => {
  try {
    ...
    return leads.map((lead) => ({
      ...
      email: lead.email,
      phone: lead.phone,
      type: lead.status === 'converted' ? 'client' as Contact['type'] : 'prospect' as Contact['type'],
      category: 'buyer' as Contact['category'],
      status: lead.status === 'not-interested' ? 'inactive' as Contact['status'] : 'active' as Contact['status'],
      source: lead.source,
      notes: lead.notes,
      ...
      interestedProperties: lead.propertyId ? [lead.propertyId] : [],
...
// Documents
export const getDocuments = (propertyId: string): Document[] => {
  initializeData();
  const documents = JSON.parse(localStorage.getItem(DOCUMENTS_KEY) || '[]');
  return documents.filter((d: Document) => d.propertyId === propertyId);
};

export const addDocument = (document: Omit<Document, 'id' | 'uploadedAt'>): Document => {
  initializeData();
  const documents = JSON.parse(localStorage.getItem(DOCUMENTS_KEY) || '[]');
...
export const getPropertyContacts = (propertyId: string): Contact[] => {
  const contacts = JSON.parse(localStorage.getItem(CRM_CONTACTS_KEY) || '[]');
  return contacts.filter((c: Contact) => c.interestedProperties.includes(propertyId));
};
